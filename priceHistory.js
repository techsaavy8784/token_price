...
function fetchPriceHistory(tokenId, days) {
    return __awaiter(this, void 0, void 0, function () {
        var response, priceData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("https://api.coingecko.com/api/v3/coins/".concat(tokenId, "/market_chart?vs_currency=usd&days=").concat(days))];
                case 1:
                    response = _a.sent();
                    priceData = response.data.prices;
                    return [2 /*return*/, priceData.map(function (data) { return data[1]; })]; // Extracting only the price values
            }
        });
    });
}
...
// Example usage
var tokenId = "solend"; // Replace with the actual token ID
var days = 7; // Fetch price history for the last 7 days
fetchPriceHistory(tokenId, days)
    .then(function (priceData) {
    var percentageIncreases = calculatePercentageIncrease(priceData);
